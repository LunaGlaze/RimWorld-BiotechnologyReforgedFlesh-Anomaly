...
{
	public class JobDriver_RefuelDigesterIPipeAtomic : JobDriver
	{
		...
		protected LunaComPipSpawnRefuelable RefuelableComp => Refuelable.TryGetComp<LunaComPipSpawnRefuelable>();
