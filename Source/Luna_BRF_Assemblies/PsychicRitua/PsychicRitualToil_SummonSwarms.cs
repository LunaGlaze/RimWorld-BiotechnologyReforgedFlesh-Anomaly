...
namespace Luna_BRF
{
    public class PsychicRitualToil_SummonSwarms : PsychicRitualToil
    {
        ...
        protected PsychicRitualToil_SummonSwarms()
        {
        }
        public PsychicRitualToil_SummonSwarms(PsychicRitualRoleDef invokerRole, FloatRange combatPointMultiplierFromQualityRange)
        {
        ...
        private void ApplyOutcome(PsychicRitual psychicRitual, Pawn invoker, float combatPointMultiplier)
        {
            ...
            Find.Storyteller.incidentQueue.Add(LunaBRFDefOf.BRF_BloodstainedParasiticedInsectAssault, Find.TickManager.TicksGame + AnimalsDelayTicks.RandomInRange, incidentParms);
