...
namespace Luna_BRF
{
    public class PsychicRitualDef_TheophagyKnockFleshHeart : PsychicRitualDef_InvocationCircle
    {
        public SimpleCurve psychicShockChanceFromQualityCurve;
        public FloatRange darkPsychicShockDurarionHoursRange;
        public SimpleCurve fleshmassheartPointsFromThreatPointsCurve;
        ...
        public override List<PsychicRitualToil> CreateToils(PsychicRitual psychicRitual, PsychicRitualGraph graph)
        {
            ...
            list.Add(new PsychicRitualToil_TheophagyKnockFleshHeart(InvokerRole, ChanterRole, psychicShockChanceFromQualityCurve));
            return list;
        }
