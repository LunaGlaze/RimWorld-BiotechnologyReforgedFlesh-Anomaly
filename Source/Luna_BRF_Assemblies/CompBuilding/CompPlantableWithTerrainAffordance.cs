...
namespace Luna_BRF
{
    ...
    public class CompPlantableWithTerrainAffordance : ThingComp
	{
        public CompProperties_PlantableWithTerrainAffordance Props => (CompProperties_PlantableWithTerrainAffordance)props;
		...
		{
			CompPlantableWithTerrainAffordance compPlantable = otherStack.TryGetComp<CompPlantableWithTerrainAffordance>();
		...
		{
			CompPlantableWithTerrainAffordance compPlantable = piece.TryGetComp<CompPlantableWithTerrainAffordance>();
			if (compPlantable == null)
			{
				return;
			}
		...
		public AcceptanceReport CanPlantAt(IntVec3 cell, Map map)
		{
			...
			if (Props.plantDefToSpawn.plant.minSpacingBetweenSamePlant > 0f)
			{
				...
				{
					CompPlantableWithTerrainAffordance compPlantable = item2.TryGetComp<CompPlantableWithTerrainAffordance>();
