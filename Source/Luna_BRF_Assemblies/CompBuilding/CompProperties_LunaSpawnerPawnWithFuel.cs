...
namespace Luna_BRF
{
	public class CompProperties_LunaSpawnerPawnWithFuel : CompProperties
	{
		public CompProperties_LunaSpawnerPawnWithFuel()
		{
			this.compClass = typeof(LunaSpawnerPawnWithFuel);
		}
